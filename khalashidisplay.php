        ...
        <section class="sheet padding-25mm" style="padding-top: 120px">
            <table class="table table-bordered">
                <tr style="font-size: 42px;">
                    <td STYLE="padding:15px;"> <div align="center">বাংলাদেশ রেলওয়ে (খালাসী) নিয়োগ পরীক্ষা</br></div>
</br>
                         <div align="center"><strong>প্রশ্নপত্রের খাম</strong> </br></div>
                        </br>
            ...
            <span style="padding-left: 920px"><?= $i++;?></span>
        </section>
    <?php endforeach; ?>
